...
variable "clusterapi_version" {
  ...
  type        = string
  default     = "1.5.0" # renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api
}

variable "capi_openstack_version" {
  description = "desired version of the OpenStack cluster-api provider"
  type        = string
  default     = "0.7.3" # renovate: datasource=github-releases depName=kubernetes-sigs/cluster-api-provider-openstack
}
